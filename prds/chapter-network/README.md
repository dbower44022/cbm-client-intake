...
| [`deployment-guide/`](deployment-guide/) | **Drafts of the New Chapter Deployment Guide** — the plan for writing it, the step list, the written-out methods for stages 8–12, 14, 16 and 17, and the work owed before any chapter can follow it | The guide is drafted further |
