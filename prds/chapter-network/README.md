...
| **[6 — First chapter](phase-6-first-chapter.md)** | **Rehearsed** (2026-08-31): steps 2, 4 and 6 run for real on a throwaway instance for a fictional chapter — record in [rehearsal-2026-08-31/](rehearsal-2026-08-31/). The instance is kept, by ruling, for step 3 | **Boston Business Mentors is the first real chapter, in progress since 2026-09-23**: the form is filled in (`chapters/boston-values.yaml`, switches answered by ruling 2026-09-24), the CRM is built and matches the standard bar the paid add-ons (stage 9, 2026-09-24), and the applications are live at apps.bbmentors.org on the release branch (stage 11, 2026-09-24). Owed: stage 10 (Google), step 9.5 and a 9.7 re-run, and the guide corrections' CRMBuilder half ([TASKS.md](TASKS.md) G1 items 21–25). **Ruled 2026-09-24 (CRMBuilder DEC-1160): Boston's hand build under this guide is its test system; its production deployment is made by the updated CRMBuilder when Boston chooses to go live.** Lakeside's step 3 (Google) and teardown remain |
