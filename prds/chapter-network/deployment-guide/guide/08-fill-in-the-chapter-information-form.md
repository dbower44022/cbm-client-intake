...
- **Chapter abbreviation** (`chapter.abbreviation`) — answered by the chapter; required.
  - *What it is:* The short form of the chapter's name, shown where space is tight and in everyday messages, such as a browser tab reading "LBM — Sessions" or "ask LBM staff". Cleveland's is CBM.
  - *Where to find it:* What the chapter already calls itself for short. Usually the initials of its name.
...
- The chapter abbreviation is filled in.
