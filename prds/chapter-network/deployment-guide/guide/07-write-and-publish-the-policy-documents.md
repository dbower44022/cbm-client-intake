...
1. Write the document with the chapter's legal adviser.
2. Publish it as a page on the chapter's website. Cleveland's is at clevelandbusinessmentors.org/client-code-of-conduct/.
...
1. Write the document with the chapter's legal adviser. It is a separate document from the client code of conduct.
2. Publish it as a page on the chapter's website. Cleveland's is at clevelandbusinessmentors.org/mentor-code-of-ethics/.
3. Open the page in a private browser window.
   *You should see:* The document, without being asked to sign in.
...
1. Write the document with the chapter's legal adviser, titled "Terms of Use" so it matches the link.
2. Publish it as a page on the chapter's website. Cleveland's is at clevelandbusinessmentors.org/legal-notices/.
3. Open the page in a private browser window.
   *You should see:* The document, without being asked to sign in.
...
1. The central support organization gives the chapter's adviser a plain list of what personal information the software collects and where it is kept. In outline - names, contact details and business details from the public forms, kept in the chapter's CRM; submissions, also held in the application database; mentoring email, copied onto the client's record; and documents, kept in the chapter's Google shared drive. There is no finished plain list yet (work list item 13).
2. The chapter writes the policy with its legal adviser.
3. Publish it as a page on the chapter's website. Cleveland's is at clevelandbusinessmentors.org/privacy-policy/.
...
1. The chapter's legal adviser reads all four documents.
2. The adviser confirms in writing that they may be published. Keep the confirmation with the chapter's records. The central support organization plays no part in this review.
   *You should see:* A written confirmation from the adviser.
...
1. Copy each address from the browser's address bar, not from memory, onto the chapter information form (step 8.3).
2. Open each address from the form itself, in a private browser window.
   *You should see:* All four documents open.
