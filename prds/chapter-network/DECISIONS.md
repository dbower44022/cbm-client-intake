...
|---|---|---|
| 2026-08-26 | **Release cadence is WEEKLY** (proposal 1). Every merge lands on staging immediately; on a weekly cadence a tag is cut and every chapter moves to it together, the soak being the week itself. A security fix may bypass the cadence but never staging. | [phase-2](phase-2-release-train.md) |
